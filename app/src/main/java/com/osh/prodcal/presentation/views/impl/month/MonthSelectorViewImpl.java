...
public class MonthSelectorViewImpl extends BaseView<MonthSelectorPresenter> implements MonthSelectorView {

    private ViewPager pager;
    private MonthAdapter monthAdapter;

    public MonthSelectorViewImpl(@NonNull Context context) {
        super(context);
    }

    public MonthSelectorViewImpl(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MonthSelectorViewImpl(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {

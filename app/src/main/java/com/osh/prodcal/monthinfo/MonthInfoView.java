...
import com.osh.prodcal.monthinfo.listitems.TitleValueItemView;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;

public class MonthInfoView extends BaseView<MonthInfoContract.Presenter> implements MonthInfoContract.View {

    private RecyclerView list;
    private ViewEntityAdapter<TitleValueItemView, TitleValueItemView.Data, TitleValueItemView.Listener> adapter;

    public MonthInfoView(@NonNull Context context) {
        super(context);
    }

    public MonthInfoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MonthInfoView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {

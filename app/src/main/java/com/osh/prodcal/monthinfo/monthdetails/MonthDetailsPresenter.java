...
public class MonthDetailsPresenter extends BasePresenterComposite<MonthDetailsContract.View> implements MonthDetailsContract.Presenter {
    ...
    @Inject
    public MonthDetailsPresenter(Navigator navigator, GetMonthEntity getMonthEntity, ObserveCurrentMonth observeCurrentMonth) {

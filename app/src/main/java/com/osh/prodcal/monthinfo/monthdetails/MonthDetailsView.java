...
import com.osh.prodcal.monthinfo.monthdetails.listitems.TitleValueItemView;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;

public class MonthDetailsView extends BaseView<MonthDetailsContract.Presenter> implements MonthDetailsContract.View {

    private RecyclerView list;
    private ViewEntityAdapter<TitleValueItemView, TitleValueItemView.Data, TitleValueItemView.Listener> adapter;

    public MonthDetailsView(@NonNull Context context) {
        super(context);
    }

    public MonthDetailsView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MonthDetailsView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
